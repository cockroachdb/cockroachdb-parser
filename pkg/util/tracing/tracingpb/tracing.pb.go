...
func init() {
	proto.RegisterEnum("cockroach.parser.util.tracing.tracingpb.RecordingMode", RecordingMode_name, RecordingMode_value)
	proto.RegisterType((*TraceInfo)(nil), "cockroach.parser.util.tracing.tracingpb.TraceInfo")
	proto.RegisterType((*TraceInfo_OtelInfo)(nil), "cockroach.parser.util.tracing.tracingpb.TraceInfo.OtelInfo")
}
